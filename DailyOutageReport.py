        ...
        if grid_data_file:
            ...
            try:
                ...
                for tenant in tenant_names:
                    ...
                    grouped_grid_data = grouped_grid_data.rename(
                        columns={
                            "Site Alias": "Total Sites",
                            "AC Availability (%)": "Average AC Availability (%)",
                            "DC Availability (%)": "Average DC Availability (%)",
                        }
                    )

                    st.subheader(f"Tenant: {tenant} - Grid Data Summary")
